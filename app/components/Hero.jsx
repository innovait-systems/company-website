...
const stats = [
  ...
  { value: "8", label: "Active Service Lines" },
];
    ...
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-page">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20">
        <div className="max-w-4xl">
          ...
          >
            <span className="section-label">Publishing & Technology Partner</span>
            <span className="h-px w-12 bg-(--accent-secondary)/60" />
            <span className="section-label opacity-60">Est. 2026</span>
          </div>
          ...
          >
            ...
            <a href="#services" className="btn-outline text-xs tracking-[0.15em]">
              OUR SERVICES
            </a>
          </div>
